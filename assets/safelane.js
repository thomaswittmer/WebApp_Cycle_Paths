let app = Vue.createApp({
    ...
    methods: {
        startAutoPlay() { // Fonction lecture automatique
        ...
        setAutoPlaySpeed(speed) { // Fonction de la lecture automatique en fonction de la vitesse de lecture
            if (this.isAutoPlaying) {
        ...
        stopAutoPlay() { // Fonction pour arrêter la lecture automatique
        ...
        pauseAutoPlay() { // Fonction pour mettre sur pause la lecture automatique
            if (this.isAutoPlaying) {
                clearInterval(this.autoPlayInterval);
                this.isAutoPlaying = false;
                this.isPaused = true;
        ...
        nextDate() { // Fonction qui permet de passer à la date suivante dans le défilement automatique du curseur
            if (this.moisChecked) {
                if (this.selectedMonth === '') {
        ...
        cherche_annee() { // Fonction pour trouver l'année en fonction du curseur
        ...
        cherche_mois_annee() { // Fonction pour trouver le mois de l'année en fonction du curseur
            this.caseChecked = false;
            this.caseDisabled = false;
        ...
        annule_annee() { // Fonction qui permet de sélectionner à nouveau toutes les années en cochant la case
...
//Empêcher que le clic sur le curseur de la barre temporelle fasse bouger la carte
...
// Fond de carte par défaut, ici la base grise clair du service ArcGIS Online
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Ajout du fond de carte topographique
