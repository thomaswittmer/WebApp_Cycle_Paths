...
- Puis vous pouvez enfin lancer l'application, il n'y a qu'à écrire [localhost](localhost) dans votre barre de recherche de n'importe quel navigateur et vous serez redirigé sur la page d'accueil de l'application = *Accueil - SAFELANE*.
